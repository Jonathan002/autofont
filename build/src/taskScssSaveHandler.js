...
/* --------------------------- */
/* ---------------- Code ---------------------- */
class TaskScssSaveHandler extends EventEmitter {
    constructor() {
        super(...arguments);
        ...
        this.tmTaskList = [
            //Part 1
            "this.tmVar['M_readScss'] = this.readScss(this.tmVar['inDir']);",
            "this.tmVar['M_splitScss'] = this.splitScss(this.tmVar['M_readScss']);",
            "this.tmVar['M_fontFaceJson'] = this.varVault('fontFaceJson');",
            "this.parseAndGenerateJsonData(this.tmVar['M_splitScss']['fixme'], 'fixme', this.tmVar['M_fontFaceJson']);",
            "this.parseAndGenerateJsonData(this.tmVar['M_splitScss']['autofont'], 'autofont', this.tmVar['M_fontFaceJson']);",
            "this.tmVar['M_readAutofontJson'] = this.readAutofontJson(this.tmVar['inDir']);",
    ...
    readScss(inDir) {
        let allFiles;
        let autofontScssFile;
        let autofontScssString;
...
exports.TaskScssSaveHandler = TaskScssSaveHandler;
